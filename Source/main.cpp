...
int main(int argc, char* argv[]) {
	...
	inset(FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY | BACKGROUND_BLUE);  std::cout << "                                           " << std::endl;
	inset(FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY | BACKGROUND_BLUE);  std::cout << "              ######      ###              " << std::endl;
	inset(FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY | BACKGROUND_BLUE);  std::cout << "                ###       ###              " << std::endl;
	inset(FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY | BACKGROUND_BLUE);  std::cout << "               ###        ###              " << std::endl;
	inset(FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY | BACKGROUND_BLUE);  std::cout << "              ###         ###              " << std::endl;
	...
	inset(FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY | BACKGROUND_BLUE);  std::cout << "         #####   ###   #   #    #          " << std::endl;
	inset(FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY | BACKGROUND_BLUE);  std::cout << "                                           " << std::endl;
	inset(FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY | BACKGROUND_BLUE);  std::cout << "    Custom   LEGO    Universe   Server     " << std::endl;
	inset(FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY | BACKGROUND_BLUE);  std::cout << "                                           " << std::endl;
	std::cout << std::endl << std::endl;
	...
	// Args parser
	int state = 0;
	std::string configFile = "..//Env//config.default.ini";
	std::string setting = "";
